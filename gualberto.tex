...
asymptotic.  Finally, we outline how the phase condition fits into
the De Bruijn--Newman framework, leading to a candidate energy
functional that would force the De Bruijn--Newman constant to zero.
\end{abstract}
...
Nevertheless, the algebraic structure and the empirical evidence
support the study of the Liouville function as a natural bridge
between the arithmetic of primes and the complex analysis of
$\zeta(s)$.
...
The author used the AI assistant Claude (Anthropic, model
deepseek-v4-flash-free, exact ID opencode/deepseek-v4-flash-free)
via the opencode CLI to assist with code generation for numerical
experiments, LaTeX formatting and style-guide compliance, and
bibliographic reference suggestions.  All AI-suggested references
were verified for existence and relevance.  The mathematical
content, arguments, and English text are the author's own work.
