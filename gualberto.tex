...
opencode/deepseek-v4-flash-free) via the opencode CLI to assist with
code generation for numerical experiments, LaTeX formatting and
style-guide compliance, and bibliographic reference suggestions.
All AI-suggested references were verified for existence and
relevance.  The mathematical content, arguments, and English text
