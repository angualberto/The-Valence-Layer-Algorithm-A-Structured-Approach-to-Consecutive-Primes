...
Riemann Hypothesis through a real-valued phase condition, proving
algebraically that this condition forces the real part of a
non-trivial zeta zero to be one-half, except for a sparse set of
