...
Seja $X = A \oplus B$ uma entrada conhecida e controlável.  A derivada
parcial discreta do bit de saída na posição $k+1$ em relação à
perturbação unitária $\Delta X = 2^k$ é dada por:
\[
