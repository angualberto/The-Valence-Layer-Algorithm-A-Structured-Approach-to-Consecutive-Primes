...
The attack requires two moduli that share the same prime $p$.
For a single isolated $N$, trial division (+2) is the fastest
method for keys up to 32 bits ($0.023$ s).  For real
RSA keys ($\ge 1024$ bits), no trial division method
is viable---RSA security remains intact for well-generated
keys.
