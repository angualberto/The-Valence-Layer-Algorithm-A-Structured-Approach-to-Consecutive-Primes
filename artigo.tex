...
\begin{figure}[htbp]
\centering
% \includegraphics[width=0.48\textwidth]{imagens/fractal_analysis.png}
\caption{Fractal analysis: Hurst R/S, auto-correlation, and
normalized gap distributions. (Image omitted)}
\label{fig:fractal}
\end{figure}
...
\begin{figure}[htbp]
\centering
% \includegraphics[width=0.8\textwidth]{imagens/liouville_cota_epsilon.png}
...
\begin{figure}[htbp]
\centering
% \includegraphics[width=0.8\textwidth]{imagens/liouville_envelope_10^8.png}
